...
public class UnsortedRingBufferSequence<E> implements RingBufferSequenceStrategy<E> {
    ...
    public UnsortedRingBufferSequence(SequenceContext<E> context) {
    ...
    public String toString() {
        ...
        public void remove() {
            ...
            UnsortedRingBufferSequence.this.remove(convertPureArrToBuffer(currentIndex));
